...
- **Главный контекст экзамена:** Селектор ЕГЭ/ОГЭ в верхней шапке является определяющим для фильтрации всех сущностей (предметы, задания, тесты, конспекты). Наборы тестов и теории для ОГЭ и ЕГЭ должны строго разделяться.
